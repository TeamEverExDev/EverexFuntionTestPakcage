...
class RaiseArmForwardLeftPosePainter extends CustomPainter {
  RaiseArmForwardLeftPosePainter(
      {this.poseModelVo,
      required this.width,
  ...
  @override
  bool shouldRepaint(covariant RaiseArmForwardLeftPosePainter oldDelegate) {
