...
class SitdownAndBendKneeLeftPosePainter extends CustomPainter {
  SitdownAndBendKneeLeftPosePainter(
      {this.poseModelVo,
      required this.width,
  ...
  @override
  bool shouldRepaint(covariant SitdownAndBendKneeLeftPosePainter oldDelegate) {
