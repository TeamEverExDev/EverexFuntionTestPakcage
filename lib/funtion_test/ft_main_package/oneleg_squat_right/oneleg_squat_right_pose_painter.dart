...
class OnelegSquatRightPosePainter extends CustomPainter {
  OnelegSquatRightPosePainter(
      {this.poseModelVo,
      required this.width,
  ...
  @override
  bool shouldRepaint(covariant OnelegSquatRightPosePainter oldDelegate) {
