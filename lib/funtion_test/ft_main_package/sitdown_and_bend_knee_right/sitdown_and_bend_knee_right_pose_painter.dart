...
class SitdownAndBendKneeRightPosePainter extends CustomPainter {
  SitdownAndBendKneeRightPosePainter(
      {this.poseModelVo,
      required this.width,
  ...
  @override
  bool shouldRepaint(covariant SitdownAndBendKneeRightPosePainter oldDelegate) {
